	...
	<div class="bg-[rgba(16,185,129,0.05)] border border-[rgba(16,185,129,0.1)] rounded-[10px] p-3.5 my-3 mb-2.5">
		{#if fiatEquivalent}
			<div class="text-center">
				<span class="block font-[Rajdhani,sans-serif] text-[28px] font-bold text-[#10b981] leading-[1.2] tabular-nums">{fiatEquivalent}</span>
				<span class="block font-mono text-[10px] text-(--text-dim) mt-1">≈${netUsd} USD</span>
			</div>
		{/if}
		{#if previewNet > 0n}
