...
<FixedOverlay show={true} onclose={onClose}>
	<div class="w-full bg-(--bg) border border-(--border) rounded-[20px] overflow-hidden max-h-[70vh] max-sm:h-[80vh] max-sm:max-h-[80vh] max-sm:rounded-b-none flex flex-col">
