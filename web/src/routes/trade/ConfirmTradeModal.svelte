...
<FixedOverlay show={true} onclose={() => { if (!isSwapping) onClose(); }}>
	<div class="w-full max-w-[420px] bg-(--bg) border border-(--border) rounded-[20px] overflow-hidden max-h-[80vh] max-sm:h-[80vh] max-sm:max-h-[80vh] max-sm:max-w-full max-sm:rounded-b-none flex flex-col">
