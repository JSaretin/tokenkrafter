...
<FixedOverlay bind:show onclose={onClose}>
	<div
		class="w-full sm:max-w-md max-h-[100dvh] sm:max-h-[90vh] overflow-y-auto bg-(--bg) border border-(--border-input) p-4 sm:p-6 rounded-t-[20px] sm:rounded-[20px] animate-slide-up sm:animate-modal-in [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden min-h-[60vh] sm:min-h-0 pb-[calc(1rem+env(safe-area-inset-bottom,0px))]"
	>
