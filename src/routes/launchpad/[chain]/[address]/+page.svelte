					...
					<div class="card p-5 mb-4">
						...
						<div class="grid grid-cols-2 gap-3">
							<div class="position-stat">
								<span class="position-stat-value"><span class="bag-amount">{formatTokens(userTokensBought, tokenMeta.decimals)} <span class="bag-symbol">{tokenMeta.symbol}</span></span></span>
								<span class="position-stat-label">Tokens Bought</span>
							</div>
							<div class="position-stat">
								<span class="position-stat-value"><span class="bag-amount">{formatUsdt(userBasePaid, ud)} <span class="bag-symbol">USDT</span></span></span>
								<span class="position-stat-label">Spent</span>
							</div>
						</div>
