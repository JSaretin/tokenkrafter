...
<style>
	...
	.meta-toggle-label { font-family: 'Syne', sans-serif; font-size: 0.82rem; font-weight: 600; color: rgba(255,255,255,0.85); flex: 1; display: inline-flex; align-items: center; gap: 8px; }
	.meta-optional {
	...
	.meta-toggle-chev { color: rgba(255,255,255,0.3); transition: transform 0.15s; flex-shrink: 0; }
